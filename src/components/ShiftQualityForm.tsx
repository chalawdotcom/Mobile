...
const styles = StyleSheet.create({
  ...
  modalTitle: { color: "#1e293b", fontSize: 17, fontWeight: "700" },
  modalDesc: { color: "#64748b", fontSize: 13 },
  form: { gap: 10 },
  input: {
  ...
  shiftText: { color: "#64748b", fontSize: 13, fontWeight: "600" },
  ...
  qualityLabel: { color: "#94a3b8", fontSize: 11, fontWeight: "700", textTransform: "uppercase", letterSpacing: 0.4 },
  qualityValue: { color: "#1e293b", fontSize: 20, fontWeight: "700", fontVariant: ["tabular-nums"] },
  errorText: { color: "#dc2626", fontSize: 12 },
  successText: { color: "#10b981", fontSize: 12 },
  hintText: { color: "#94a3b8", fontSize: 11 },
